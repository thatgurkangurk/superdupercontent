...
public class NeoForgeExceptionHandler extends DefaultExceptionHandler<NeoForgeCommandActor> {

    @HandleException
    public void onInvalidPlayer(InvalidPlayerException e, NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cInvalid player: &e" + e.input() + "&c."));
    }

    @HandleException
    public void onInvalidWorld(InvalidWorldException e, NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cInvalid world: &e" + e.input() + "&c."));
    }

    @HandleException
    public void onSenderNotPlayer(SenderNotPlayerException e, NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cYou must be a player to execute this command!"));
    }

    @HandleException
    public void onSenderNotConsole(SenderNotConsoleException e, NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cYou must be a player to execute this command!"));
    }

    @Override public void onEnumNotFound(@NotNull EnumNotFoundException e, @NotNull NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cInvalid choice: &e" + e.input() + "&c. Please enter a valid option from the available values."));
    }

    @Override public void onExpectedLiteral(@NotNull ExpectedLiteralException e, @NotNull NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cExpected &e" + e.node().name() + "&c, found &e" + e.input() + "&c."));
    }

    @Override public void onInputParse(@NotNull InputParseException e, @NotNull NeoForgeCommandActor actor) {
        switch (e.cause()) {
    ...
    @Override
    public void onInvalidListSize(@NotNull InvalidListSizeException e, @NotNull NeoForgeCommandActor actor, @NotNull ParameterNode<NeoForgeCommandActor, ?> parameter) {
    ...
    @Override
    public void onInvalidStringSize(@NotNull InvalidStringSizeException e, @NotNull NeoForgeCommandActor actor, @NotNull ParameterNode<NeoForgeCommandActor, ?> parameter) {
    ...
    @Override public void onInvalidBoolean(@NotNull InvalidBooleanException e, @NotNull NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cExpected &etrue &cor &efalse&c, found &e" + e.input() + "&c."));
    }

    @Override public void onInvalidDecimal(@NotNull InvalidDecimalException e, @NotNull NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cInvalid number: &e" + e.input() + "&c."));
    }

    @Override public void onInvalidInteger(@NotNull InvalidIntegerException e, @NotNull NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cInvalid integer: &e" + e.input() + "&c."));
    }

    @Override public void onInvalidUUID(@NotNull InvalidUUIDException e, @NotNull NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cInvalid UUID: " + e.input() + "&c."));
    }

    @Override
    public void onMissingArgument(@NotNull MissingArgumentException e, @NotNull NeoForgeCommandActor actor, @NotNull ParameterNode<NeoForgeCommandActor, ?> parameter) {
        actor.error(legacyColorize("&cRequired parameter is missing: &e" + parameter.name() + "&c. Usage: &e/" + parameter.command().usage() + "&c."));
    }

    @Override public void onNoPermission(@NotNull NoPermissionException e, @NotNull NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cYou do not have permission to execute this command!"));
    }

    @Override
    public void onNumberNotInRange(@NotNull NumberNotInRangeException e, @NotNull NeoForgeCommandActor actor, @NotNull ParameterNode<NeoForgeCommandActor, Number> parameter) {
    ...
    @Override public void onInvalidHelpPage(@NotNull InvalidHelpPageException e, @NotNull NeoForgeCommandActor actor) {
    ...
    @Override public void onUnknownCommand(@NotNull UnknownCommandException e, @NotNull NeoForgeCommandActor actor) {
        actor.error(legacyColorize("&cUnknown command: &e" + e.input() + "&c."));
    }

    @Override public void onValueNotAllowed(@NotNull ValueNotAllowedException e, @NotNull NeoForgeCommandActor actor) {
